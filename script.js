document.addEventListener('DOMContentLoaded', () => {
    ...
    const sekundePocetakSegmentaInput = document.getElementById('sekundePocetakSegmenta'); // ISPRAVLJENO: sekundePocetakSegmentaInput
    ...
    function setupAutoAdvance() {
        const orderedInputs = [
            ...
            satiPocetakSegmentaInput, minutePocetakSegmentaInput, sekundePocetakSegmentaInput, frameoviPocetakSegmentaInput, // ISPRAVLJENO OVDJE
    ...
    function generateAndDownloadXML() {
        ...
        xmlContent += `    <edius:CreateDate>${dayOfWeek} ${month} ${day